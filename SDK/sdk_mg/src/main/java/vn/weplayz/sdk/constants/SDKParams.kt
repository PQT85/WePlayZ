package vn.weplayz.sdk.constants
...
//        )
    fun getHashCodeConfig(DeviceID : String ,RequestTime : String,appSecretKey : String) =
        hashCode256 (
//            input = "${appKey}${Constants.VERSION_SDK}${dateTime}",
            input = "${vn.weplayz.sdk.constants.Constants.VERSION_SDK}${DeviceID}${vn.weplayz.sdk.constants.Constants.CLIENT_OS}${RequestTime}",
            key = appSecretKey
        )
    ...
    fun getHashCodeGetListDefinePackage(deviceId: String, dateTime: String,appSecretKey: String) =
        hashCode256(
            input = "${deviceId}${vn.weplayz.sdk.constants.Constants.CLIENT_OS}${dateTime}",
            key = appSecretKey
        )
