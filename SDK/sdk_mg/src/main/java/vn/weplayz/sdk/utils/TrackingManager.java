...
import vn.weplayz.sdk.models.MigaAdjustConfig;
...
//    private static AppEventsLogger logger ;
    ...
    {
        MigaAdjustConfig adjustConfig = SDKWeplayZManager.getAdjustConfig();
...
//        logger = AppEventsLogger.newLogger(_context);
    ...
    public static void trackEventRevenue(final String eventName,final float value,final String jsonContent)
    {
        ...
        if(SDKWeplayZManager.getAdjustConfig() != null) {
