...
//
//        }
        vn.weplayz.sdk.constants.Constants.showDataLog(vn.weplayz.sdk.constants.Constants.LOG_TAG, "POST_REQUEST_URL: $requestURL")
    ...
    fun addField(name: String, value: String): PostRequest {
        vn.weplayz.sdk.constants.Constants.showDataLog(vn.weplayz.sdk.constants.Constants.LOG_TAG, "addField :: ${name}= ${value}")
    ...
    fun addHeader(name: String, value: String): PostRequest {
        vn.weplayz.sdk.constants.Constants.showDataLog(vn.weplayz.sdk.constants.Constants.LOG_TAG, "add Header :: ${name}= ${value}")
